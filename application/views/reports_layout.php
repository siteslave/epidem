            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="<?=site_url('patients')?>"><i class="icon-th-list"></i> ทะเบียนผู้ป่วย : E0</a></li>
                        <li><a href="<?=site_url('reports/e1');?>"><i class="icon-plus-sign-alt"></i> ทะเบียนผู้ป่วยรายโรค : E1</a></li>
